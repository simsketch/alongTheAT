...
include_once 'php_includes/db_connects.php';
   ...
   $tbl_users = "CREATE TABLE IF NOT EXISTS users( # IF NOT EXISTS stops from creating existing table
               ...
               notescheck DATETIME NOT NULL, # notifications handler
               activated ENUM('0','1') NOT NULL DEFAULT '0', # change to 1 after email verification
               PRIMARY KEY (id),
               UNIQUE KEY username (username, email)
               )";

               $query = mysqli_query($db_conx, $tbl_users);    # oop and functional mysqli
               # $query = $db_conx->query($tbl_users);         # can be interchanged
               ...
               $tbl_useroptions = "CREATE TABLE IF NOT EXISTS useroptions (
                               ...
                               username VARCHAR(16) NOT NULL,
                  				...
                  				question VARCHAR(255) NULL, # security question
                  				answer VARCHAR(255) NULL, # security question answer
                               PRIMARY KEY (id),
               ...
               $tbl_friends = "CREATE TABLE IF NOT EXISTS friends (
                               id INT(11) NOT NULL AUTO_INCREMENT,
                               user1 VARCHAR(16) NOT NULL, # requestor
                               user2 VARCHAR(16) NOT NULL, # acceptor
                               datemade DATETIME NOT NULL, # datetime accepted
                               accepted ENUM('0','1') NOT NULL DEFAULT '0', # 1 for accepted
                               PRIMARY KEY (id)
                               )";
               ...
               ////////////////////////////////////
               $tbl_status = "CREATE TABLE IF NOT EXISTS status (  # conversations table
                               id INT(11) NOT NULL AUTO_INCREMENT,
